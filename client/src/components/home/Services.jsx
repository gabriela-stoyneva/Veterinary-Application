        ...
        <>
            <section className={style.services}>
                <article className={style.articleService}>
                    <p><i className="fa-solid fa-shield-dog"></i></p>
                ...
                <article className={style.articleService}>
                    <p><i className="fa-solid fa-house-medical"></i></p>
